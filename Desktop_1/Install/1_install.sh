...
sudo pacman -S --noconfirm --needed sway swaylock swayidle waybar xorg-server-xwayland termite rofi imagemagick grim slurp wl-clipboard python-pynvim python-msgpack
